...
An opt-in feature for Target ROAS campaigns that temporarily eases ROAS targets to discover new, untapped search traffic:
...
- **When to avoid**: Tight-margin accounts or campaigns already spending full budget
...
- Budget should be ≥50× target CPA per ad group
